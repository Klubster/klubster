 ...
 * connaissait ou devinait un `pieceId` pouvait déposer un fichier dessus. La protection
 * reposait entièrement sur des politiques RLS non vérifiables depuis le code (relevé à
 * l'audit du 21/07/2026). Elle est désormais explicite ici aussi.
 */
